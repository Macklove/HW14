//
//  SectionFifthCollectionViewCell.swift
//  HW14
//
...
class SectionFifthCollectionViewCell: UICollectionViewCell {
    
    // MARK: - Elements
    
    static let identifier = "SectionFifthCollectionViewCell"
