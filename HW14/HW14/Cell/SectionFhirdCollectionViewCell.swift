//
//  SectionFhirdCollectionViewCell.swift
//  HW14
//
...
class SectionFhirdCollectionViewCell: UICollectionViewCell {
    
    // MARK: - Elements
    
    static let identifier = "SectionFhirdCollectionViewCell"
    ...
    public func configure(with model: FotoPeopleAndPlace) {
